...
struct Discretizer
    ...
    function Discretizer(ωbranch, ρbranch, weightbranch, 
        ...
        interp_R = DataInterpolations.LinearInterpolation(R, bsign .* ωbranch; extrapolate=true)
        interp_iR = DataInterpolations.LinearInterpolation(bsign .* ωbranch, R; extrapolate=true)
        # interp_R = DataInterpolations.LinearInterpolation(R, bsign .* ωbranch; extrapolation=ExtrapolationType.Linear)
        # interp_iR = DataInterpolations.LinearInterpolation(bsign .* ωbranch, R; extrapolation=ExtrapolationType.Linear)
        xs = range(1., xmax, Nx)
